...
public class ValidationError {
	...
	public final static int ERROR_TOO_MANY = 1;
	/** 2. Referred directory sector outside of image. */
	public final static int ERROR_DIR_SECTOR_OUTSIDE_IMAGE = 2;
	/** 3. Directory sector was already seen (cyclic reference detected). */
	public final static int ERROR_DIR_SECTOR_ALREADY_SEEN = 3;
	/** 4. Directory sector already seen and marked as used. */
	public final static int ERROR_DIR_SECTOR_ALREADY_USED = 4;
	/** 5. Directory sector already seen and marked as free. */
	public final static int ERROR_DIR_SECTOR_ALREADY_FREE = 5;
	/** 6. Partitions are only supported on D81 images. */
	public final static int ERROR_PARTITIONS_UNSUPPORTED = 6;
	/** 7. Referred file sector outside of image. */
	public final static int ERROR_FILE_SECTOR_OUTSIDE_IMAGE = 7;
	/** 8. File sector already seen (cyclic reference detected). */
	public final static int ERROR_FILE_SECTOR_ALREADY_SEEN = 8;
	/** 9. File sector already seen and marked as used. */
	public final static int ERROR_FILE_SECTOR_ALREADY_USED = 9;
	/** 10. File sector already seen and marked as free. */
	public final static int ERROR_FILE_SECTOR_ALREADY_FREE = 10;	
	/** 11. Used sector is marked as free. */
	public final static int ERROR_USED_SECTOR_IS_FREE = 11;
	/** 12. Unused sector is marked as used. */
	public final static int ERROR_UNUSED_SECTOR_IS_ALLOCATED = 12;
	/** 13. BAM free sector mismatch. */
	public final static int ERROR_BAM_FREE_SECTOR_MISMATCH = 13;
