...
public class D71 extends DiskImage {
	...
	private final static int BAM_TRACK_1 = 18;
	/** Track number of BAM 2 */
	private final static int BAM_TRACK_2 = 53;
	/** Sector number of BAM 1 and 2 */
	private final static int BAM_SECT  = 0;
...
//	private int sector;
	...
	public byte[] writeSaveData(int number) throws CbmException {
		if (cbmDisk == null) {
			...
			if (cbmFile[number] instanceof CpmFile) {
				...
				//System.out.println("D71.writeSaveData: recCount="+cpm.getRecordCount()+" size="+(cpm.getRecordCount() * CPM_RECORD_SIZE));
				//System.out.println("D71.writeSaveData: allocList="+cpm.getAllocList());
	...
	public boolean saveNewImage(String filename, String newDiskName, String newDiskID) {
		...
		for (int i = 0; i < newD71Data.length; i++) {
		       setCbmDiskValue(91392+i, newD71Data[i]);
		}
	...
	public void deleteFile(CbmFile cbmFile) throws CbmException {
		throw new CbmException("Delete not yet implemented for D71.");		
	}
